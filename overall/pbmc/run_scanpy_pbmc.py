...
log_file = "pbmc_scanpy_cpu_{}.log".format(sc.settings.n_jobs)
fp = open(log_file, 'w')

filter_norm_data = "/data/5k_pbmc_v3_filter_norm.h5ad"
hvf_file = "/data/5k_pbmc_v3_hvf.txt"
pca_data = "/data/5k_pbmc_v3_filter_norm_pca.h5ad"
pca_knn_data = "/data/5k_pbmc_v3_pca_knn.h5ad"

print("Reading PBMC dataset")
...
end_hvg = time.time()
record_time(end_hvg - start_hvg, "HVG", fp)
...
adata = sc.read_h5ad(pca_knn_data)
...
adata.write("scanpy_5k_pbmc_result.h5ad", compression = 'gzip')
