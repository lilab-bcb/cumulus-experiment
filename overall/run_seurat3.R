...
print(logstr.hvg)
write(paste("HVG time:", logstr.hvg), file = logfile)
...
print(logstr.pca)
write(paste("PCA time:", logstr.pca), file = logfile, append = TRUE)
...
print(logstr.knn)
write(paste("KNN time:", logstr.knn), file = logfile, append = TRUE)
...
write(paste("Clustering time:", logstr.cluster), file = logfile, append = TRUE)
...
print(logstr.umap)
write(paste("UMAP time:", logstr.umap), file = logfile, append = TRUE)
...
print(logstr.tsne)
write(paste("TSNE time:", logstr.tsne), file = logfile, append = TRUE)
