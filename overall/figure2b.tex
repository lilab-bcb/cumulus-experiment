...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\hline 
		Clustering & ? & \textcolor{red}{23 min 14 sec} & \textbf{50 sec}\\
		\hline
		t-SNE-based visualization & ? & \textcolor{red}{15 min 54 sec} & \textbf{2 min 49 sec}\\
		\hline
		UMAP-based visualization & ? & \textcolor{red}{13 min 29 sec} & \textbf{2 min 29 sec}\\
		\hline
