...
if __name__ == '__main__':
	...
	if os.system('pegasus plot scatter --basis fitsne --attributes anno --set-palettes "{palettes}" {src}.h5ad Figure_S5A_left.pdf'.format(palettes = palettes_spectral, src = data_dst)):
		sys.exit(1)
