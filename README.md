...
`
	(pegasus-env) $ cd /experiment/highly_variable_features
`

Then execute the experiment:

`
	(pegasus-env) $ python gen_result.py
`
...
`
	(pegasus-env) $ cd /experiment/batch_correction/ground
	(pegasus-env) $ python gen_ground_h5ad.py
	(pegasus-env) $ python gen_celltype.py
`
...
`
	(pegasus-env) $ cd /experiment/batch_correction/baseline
	(pegasus-env) $ python run_baseline.py
`
...
`
	(pegasus-env) $ cd /experiment/batch_correction/pegasus
	(pegasus-env) $ python run_pegasus_batch_correct.py
`
...
`
	(scanpy-env) $ cd /experiment/batch_correction/combat
	(scanpy-env) $ python scanpy_combat.py
`
...
`
	(scanpy-env) $ cd /experiment/batch_correction/mnn
	(scanpy-env) $ python scanpy_mnn.py
`
...
`
	(scanpy-env) $ cd /experiment/batch_correction/bbknn
	(scanpy-env) $ python scanpy_bbknn.py
`
...
`
	$ cd /experiment/batch_correction/seurat
...
`
	(pegasus-env) $ python measure_result.py baseline
	(pegasus-env) $ python measure_result.py pegasus
	(pegasus-env) $ python measure_result.py seurat
	(pegasus-env) $ python measure_result.py combat
	(pegasus-env) $ python measure_result.py bbknn
	(pegasus-env) $ python measure_result.py mnn
`
...
`
	(pegasus-env) $ python measure_result.py plot
`
...
`
	(pegasus-env) $ cd /experiment/knn_comparison
	(pegasus-env) $ python knn_comp.py brute
`
...
`
	(pegasus-env) $ cd /experiment/knn_comparison
	(pegasus-env) $ python knn_comp.py pegasus
`
...
`
	(pegasus-env) $ cd /experiment/knn_comparison
	(pegasus-env) $ python knn_comp.py scanpy
`
...
`
	(pegasus-env) $ cd /experiment/knn_comparison
	(pegasus-env) $ Rscript seurat_knn.R
	(pegasus-env) $ python knn_comp.py seurat
`
...
`
	(pegasus-env) $ cd /experiment/knn_comparison
	(pegasus-env) $ python knn_comp.py plot
`
